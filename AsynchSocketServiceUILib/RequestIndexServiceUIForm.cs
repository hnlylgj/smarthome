...
{
    public class RequestIndexServiceUIForm : AsynchSocketSeverUIFormBaseFrame 
    {
        ...
        protected override void InitMainGridUIStyles()
        {
            ...
            this.Icon = (System.Drawing.Icon)(Properties.Resources.lgjRequestIndex);
            this.Text = "第吉尔请求索引服务器-->智能总线服务";
            this.MessageNotifyIconText = "第吉尔请求索引服务器:";
            this.MessageNotifyIcon.Icon = (System.Drawing.Icon)(Properties.Resources.lgjRequestIndex);
            this.MessageNotifyIcon.Text = "第吉尔请求索引服务器-->智能总线服务";
        }
        private void InitAsynchSocketSet()
        {
            //nSocketServiceTypeID = SocketServiceTypeID.RequestIndexServer;  
            //MyLockServerAsynchSocketServiceBaseFrame = new LGJAsynchSocketService.AsynchRequestIndexSocketService();
            //MyLockServerAsynchSocketServiceBaseFrame.MyManagerSocketLoginUser = this.MyManagerSocketLoginUser; 
            //MyLockServerAsynchSocketServiceBaseFrame.MyRefreshNotifyCallBack = new LGJAsynchSocketService.AsynchRequestIndexSocketService.AsynchRefreshNotifyHandler(this.InvokeAllProcess);

            //MyLockServerAsynchSocketServiceBaseFrame = new LGJAsynchSocketService.AsynchRequestIndexSocketService();
            //MyLockServerAsynchSocketServiceBaseFrame.MyRefreshNotifyCallBack = new AsynchRequestIndexSocketService.AsynchRefreshNotifyHandler(this.InvokeAllProcess);
