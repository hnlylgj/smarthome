...
namespace LGJAsynchSocketService.LockServerLib
{
    public class RemoteOpen
    {
        ...
        public RemoteOpen(AsynchLockServerSocketService InAsynchLockServerSocketService, LoginUser MeLoginUser, int MeRecieveCount)
        {
            //最新版本
        ...
        public void ResponseToMobile()
        {
            ...
            string CommandMessageID = "remoteopen";
            //---1.找智能锁本身通道的路由表记录-------------------------------------          
        ...
        {            
            ...
            {
                HexSendMessageIDString = "0150";
            }
            else
            {
                HexSendMessageIDString = "5001";
            }
