...
namespace LGJAsynchSocketService.LockServerLib
{
    public  class mobileoffline
    {
            ...
            public mobileoffline(AsynchLockServerSocketService InAsynchLockServerSocketService, LoginUser MeLoginUser, int MeRecieveCount)
            {
                //最新版本
            ...
            public mobileoffline(AsynchLockServerSocketService InputAsynchSocketServiceBaseFrame, SocketServiceReadWriteChannel InputReadWriteChannel, int InRecieveCount)
            {
                //老版本
            ...
            {
                int MySendByteCount = 23;//22+1=23字节头
                ...
                {
                    HexSendMessageIDString = "0550";
                }
                else
                {
                    HexSendMessageIDString = "5005";
                }
